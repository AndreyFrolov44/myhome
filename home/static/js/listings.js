...
//    $.each($('.listing_price'), function(index, data){
//        console.log(data);
////        data.text(prettify(data.text()));
//    });
//    $('.listing_price').text(prettify($('.listing_price').text()));
    $('.listing_box').removeAttr( 'style' );
    $('.listings_container').removeAttr( 'style' );
